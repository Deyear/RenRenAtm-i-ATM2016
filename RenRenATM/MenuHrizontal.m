...
-(void)createMenuItems:(NSArray *)aItemsArray{
    ...
    for (NSDictionary *lDic in aItemsArray) {
        ...
        [vButton setTitleColor:[UIColor colorWithRed:90.0f/255.0f green:90.0f/255.0f blue:90.0f/255.0f alpha:1] forState:UIControlStateNormal];


            [vButton.titleLabel setFont:[UIFont systemFontOfSize:14]];
//        [vButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
        [vButton setTitleColor:[UIColor colorWithRed:71.0f/255.0f green:115.0f/255.0f blue:185.0f/255.0f alpha:1]  forState:UIControlStateSelected];
...
-(void)menuButtonClicked:(UIButton *)aButton{
    ...
    [aButton.titleLabel setFont:[UIFont systemFontOfSize:17]];
            [aButton setTitleColor:[UIColor colorWithRed:71.0f/255.0f green:115.0f/255.0f blue:185.0f/255.0f alpha:1]  forState:UIControlStateSelected];
}
