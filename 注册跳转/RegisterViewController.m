...
{
    //整个上下滚动view
    SelfScrollerView =[[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-64)];
    //设置容量
...
{
    //整个上下滚动view
    uiRightView =[[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-64)];
    //设置容量
...
//    }
    ...
    agreeButton1.titleLabel.font = [UIFont systemFontOfSize:14];
...
//            NSString *service_item_ids = [NSString stringWithFormat:@"%@%@%@%@%@%@%@%@",ONE,TWO,THREE,FOUR,FIVE,SIX,SEVEN,EIGHT];
            NSDictionary *parameters = @{@"username":nameleftField.text,
                                         @"password":phoneLeftField.text,
                                         @"password_repeat":mimaleftField.text,
                                         @"role":getiOrdianpu,
                                         @"service_item_ids":service_item_ids,
                                         @"captcha":codeLeftField.text};
            AFHTTPSessionManager *session = [AFHTTPSessionManager manager];
...
//        NSLog(@"2");
        ...
        else
        {
            ...
            NSDictionary *parameters = @{@"username":nameRightField.text,
                                         @"password":phoneRightField.text,
                                         @"password_repeat":mimaRightField.text,
                                         @"captcha":codeRightField.text};
            AFHTTPSessionManager *session = [AFHTTPSessionManager manager];
